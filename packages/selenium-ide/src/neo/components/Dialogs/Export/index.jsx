...
export default class ExportDialog extends React.Component {
  ...
  exportTestcaseToServer = async () => {
    ...
    this.state.groups.map(group => {
      if (group.siteGroupId == this.state.selectedGroup) {
        ...
        data.webUrl = UiState.displayedTest.webUrl
      }
    })
  ...
  addTestcaseTogroup = testcaseId => {
    ...
    API.post(testcaseData)
      ...
      .catch(err => {
        ...
        toast.error('Failed to export test case to server')
        this.setState({
          exportSucccess: false,
        })
      })
  ...
  render() {
    return (
      <>
        {!this.state.siteModal &&
        !this.state.groupModal &&
        !this.state.exportSucccess ? (
          <Modal
          ...
          >
            ...
            <SaveTestContent
              siteModal={this.state.siteModal}
              groupModal={this.state.groupModal}
              handleSiteOpening={this.handleSiteOpening}
          ...
          >
            <CreateSiteModal
              {...this.props}
              siteUrlChangeHandler={this.siteUrlChangeHandler}
          ...
          >
            <CreateGroupModal
              {...this.props}
              groupNameChangeHandler={this.groupNameChangeHandler}
      ...
      >
        <div style={{ padding: '15px' }}>
          <TextField
            ...
            id="outlined-basic-siteName"
            label="Site Name"
            variant="outlined"
            type="text"
            onChange={e => this.props.siteNameChangeHandler(e)}
          />
          <TextField
            value={this.props.siteUrl}
            style={{ marginTop: '20px' }}
            className="my-3 labelled-input"
            id="outlined-basic-siteUrl"
            label="Site Url"
            variant="outlined"
            type="text"
            onChange={e => this.props.siteUrlChangeHandler(e)}
          />
        </div>
      </DialogContainer>
    )
      ...
      >
        <div style={{ padding: '15px' }}>
            ...
            >
              {this.props.sites.length > 0
                ? this.props.sites.map((site, key) => {
                    return (
                      <option key={key} value={site.siteId}>
                        {site.siteName}
                      </option>
                    )
                  })
          ...
          <TextField
            ...
            variant="outlined"
            type="text"
            onChange={e => this.props.groupNameChangeHandler(e)}
          />
        </div>
      </DialogContainer>
    )
      ...
      <DialogContainer
        ...
        buttons={[
          <FlatButton
            key="ok"
            type="submit"
            onClick={this.props.exportTestcaseToServer}
          >
            Export
          </FlatButton>,
          <FlatButton
        ...
        {this.props.loading ? (
          ...
          <div>
            ...
            >
              Dont have site?
              <a
                onClick={this.props.handleSiteOpening}
            ...
            <FormControl style={{ display: 'block' }} variant="outlined">
              {/* <InputLabel  htmlFor="filled-site-native-simple">Site</InputLabel> */}
              <label style={{ marginTop: '25px', paddingLeft: '20px' }}>
                Site
              </label>
              <Select
            ...
            >
              Dont have Group?
              <a
                onClick={this.props.handleGroupOpening}
                href="javascript:void(0);"
                style={{
                  fontWeight: 'bold',
                  cursor: 'pointer',
            ...
            <TextField
              ...
              variant="outlined"
              type="text"
              onChange={e => this.props.testcaseChangedHandler(e)}
            />
          </div>
        )}
      </DialogContainer>
